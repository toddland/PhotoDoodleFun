...
(function () {
    ...
    var page = WinJS.UI.Pages.define("/html/SettingsPane.html", {
        ready: function (element, options) {
//            document.getElementById("getFiles").addEventListener("click", ShowAndTell.getFiles, false);
    ...
    function onExtendView() {
        var extend = true;//extendView.checked;
        titleBarHelper.extendViewIntoTitleBar = extend;
        if (extend) {
            ShowAndTell.addCustomTitleBar().done();
        } else {
            ShowAndTell.removeCustomTitleBar().done();
        }
    }
