...
(function () {
    ...
    function InitializeMap() {
        var mapItemDiv = document.getElementById("mapHost");
    ...
    function addPushpin(latVal, longVal, description, dateTaken) {
        ...
        if (latVal != null && longVal != null) {
            ...
            //pushpins
            pushPinIndex++;
            var pushpinOptions = { icon: '/images/pushpin.png' };  //also located at https://i-msdn.sec.s-msft.com/dynimg/IC488534.png
    ...
    function displayEventInfo(e) {
        if (e.targetType = "pushpin") {
            ...
            if (ShowAndTell.ListView.itemsList._keyMap[indexThumb] != null) {
                ...
                document.getElementById('mapHost').appendChild(infoBox);

                if ((Windows.UI.ViewManagement.ProjectionManager.projectionDisplayAvailable == true || ShowAndTell.projectionDisplayEnabled == true) &&
                    Windows.Storage.ApplicationData.current.roamingSettings.values["ProjectionEnabled"] == true) {
